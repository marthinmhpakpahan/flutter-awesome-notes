...
import 'package:awesome_notes_firebase/change_notifiers/notes_provider.dart';
...
class NewNoteController extends ChangeNotifier {
  ...
  void saveNote(BuildContext context) {
    ...
    final Note note = Note(title: newTitle, content: newContent, contentJson: contentJson, dateCreated: now, dateModified: now, tags: tags);
